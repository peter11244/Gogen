# -*- coding: utf-8 -*-
"""
Created on Wed Jan 31 01:44:19 2018
...
for count in range(1000):
    ...
    if giveupcount > 10:
        ...
        newn = [x for x in cl2 if x[0] not in [y[0] for y in solved]]
        solved.append(newn)
        cl2 = [x for x in cl2 if x==newn or x[0] != newn[0]]
